...
function HEX5BHEX5D_59067(s_59072, x_59075) {
	var result_59076 = null;

	var F={procname:"[].[]",prev:framePtr,filename:"../../../../../../root/.choosenim/toolchains/nim-#devel/lib/system.nim",line:0};
	framePtr = F;
		F.line = 3708;
		var a_59201 = x_59075.a;
		F.line = 3709;
		var l_59401 = addInt(subInt(x_59075.b, a_59201), 1);
		F.line = 3710;
		result_59076 = nimCopy(null, mnewString(chckRange(l_59401, 0, 2147483647)), NTI138);
		L1: do {
			F.line = 3711;
			var i_59411 = 0;
			F.line = 3668;
			...
			L2: do {
				F.line = 3669;
					L3: while (true) {
					if (!(i_221531 < l_59401)) break L3;
						F.line = 3670;
						i_59411 = i_221531;
						F.line = 3711;
						result_59076[chckIndx(i_59411, 0, result_59076.length+0-1)-0] = s_59072[chckIndx(addInt(i_59411, a_59201), 0, s_59072.length+0-1)-0];
						F.line = 3671;
						i_221531 = addInt(i_221531, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function HEX2EHEX2E_59021(a_59026, b_59028) {
	var result_59030 = {a: 0, b: 0};

	var F={procname:".....",prev:framePtr,filename:"../../../../../../root/.choosenim/toolchains/nim-#devel/lib/system.nim",line:0};
	framePtr = F;
		F.line = 396;
		result_59030.a = a_59026;
		F.line = 397;
		result_59030.b = b_59028;
	framePtr = F.prev;
...
function HEX5BHEX5D_91105(s_91110, x_91113) {
	var result_91114 = null;

	var F={procname:"[].[]",prev:framePtr,filename:"../../../../../../root/.choosenim/toolchains/nim-#devel/lib/system.nim",line:0};
	framePtr = F;
		F.line = 3708;
		var a_91201 = x_91113.a;
		F.line = 3709;
		var l_91401 = addInt(subInt(subInt((s_91110 != null ? s_91110.length : 0), x_91113.b), a_91201), 1);
		F.line = 3710;
		result_91114 = nimCopy(null, mnewString(chckRange(l_91401, 0, 2147483647)), NTI138);
		L1: do {
			F.line = 3711;
			var i_91411 = 0;
			F.line = 3668;
			...
			L2: do {
				F.line = 3669;
					L3: while (true) {
					if (!(i_215125 < l_91401)) break L3;
						F.line = 3670;
						i_91411 = i_215125;
						F.line = 3711;
						result_91114[chckIndx(i_91411, 0, result_91114.length+0-1)-0] = s_91110[chckIndx(addInt(i_91411, a_91201), 0, s_91110.length+0-1)-0];
						F.line = 3671;
						i_215125 = addInt(i_215125, 1);
					}
			} while(false);
		} while(false);
	framePtr = F.prev;
...
function HEX2EHEX2E_91053(a_91058, b_91060) {
	var result_91068 = {a: 0, b: 0};

	var F={procname:".....",prev:framePtr,filename:"../../../../../../root/.choosenim/toolchains/nim-#devel/lib/system.nim",line:0};
	framePtr = F;
		F.line = 396;
		result_91068.a = a_91058;
		F.line = 397;
		result_91068.b = b_91060;
	framePtr = F.prev;
...
function nsuUnindent(s_138455, count_138456, padding_138457) {
						var Tmp6;
											var Tmp10;

	var result_138458 = null;

		result_138458 = nimCopy(null, [], NTI138);
		var i_138460 = 0;
		L1: do {
			var line_138461 = null;
			var first_221512 = 0;
			var last_221514 = 0;
			var eolpos_221516 = 0;
			L2: do {
					...
					if (!true) break L3;
						L4: do {
								L5: while (true) {
								if (!((last_221514 < (s_138455 != null ? s_138455.length : 0)) && !((ConstSet2[s_138455[last_221514]] != undefined)))) break L5;
									last_221514 += 1;
								}
						} while(false);
						eolpos_221516 = last_221514;
						if ((last_221514 < (s_138455 != null ? s_138455.length : 0))) {
						if ((s_138455[last_221514] == 10)) {
						last_221514 += 1;
						}
						else {
						if ((s_138455[last_221514] == 13)) {
						last_221514 += 1;
						if (((last_221514 < (s_138455 != null ? s_138455.length : 0)) && (s_138455[last_221514] == 10))) {
						last_221514 += 1;
						}
						...
						Tmp6 = (eolpos_221516 - 1);
						}
						
						line_138461 = substr_24422(s_138455, first_221512, Tmp6);
						if (!((i_138460 == 0))) {
						if (result_138458 != null) { result_138458 = (result_138458).concat(makeNimstrLit("\x0A")); } else { result_138458 = makeNimstrLit("\x0A"); };
						}
						
						var indent_count_138463 = 0;
						L7: do {
							var j_138473 = 0;
							var colontmp__221503 = 0;
							colontmp__221503 = count_138456;
							var i_221505 = 0;
							L8: do {
									L9: while (true) {
									if (!(i_221505 < colontmp__221503)) break L9;
										j_138473 = i_221505;
										indent_count_138463 += 1;
											if (((line_138461 != null ? line_138461.length : 0) <= ((j_138473 + (padding_138457 != null ? padding_138457.length : 0)) - 1))) Tmp10 = true; else {												Tmp10 = !(eqStrings(HEX5BHEX5D_59067(line_138461, HEX2EHEX2E_59021(j_138473, ((j_138473 + (padding_138457 != null ? padding_138457.length : 0)) - 1))), padding_138457));											}										if (Tmp10) {
										indent_count_138463 = j_138473;
										break L7;
										}
						...
						if (result_138458 != null) { result_138458 = (result_138458).concat(HEX5BHEX5D_91105(line_138461, HEX2EHEX2E_91053((indent_count_138463 * (padding_138457 != null ? padding_138457.length : 0)), 1))); } else { result_138458 = HEX5BHEX5D_91105(line_138461, HEX2EHEX2E_91053((indent_count_138463 * (padding_138457 != null ? padding_138457.length : 0)), 1)).slice(); };
						i_138460 += 1;
						if ((eolpos_221516 == last_221514)) {
						break L2;
						}
						
						first_221512 = last_221514;
					}
			} while(false);
		} while(false);
...
function nsuUnindentAll(s_138593) {
	var result_138594 = null;

		result_138594 = nimCopy(null, nsuUnindent(s_138593, 1000, makeNimstrLit(" ")), NTI138);

	return result_138594;
...
tagTempl(bindLit(document.getElementById("ROOT")), (toJSStr(nsuUnindentAll(makeNimstrLit("  <h-welcome name=\"Sara\"></h-welcome>\x0A  <h-welcome name=\"Cahal\"></h-welcome>\x0A  <h-welcome name=\"Edite\"></h-welcome>\x0A")))));
